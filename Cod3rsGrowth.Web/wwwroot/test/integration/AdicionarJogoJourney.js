sap.ui.define([
	...
	opaTest("Os inputs devem ficar em estado de erro caso tente salvar com eles vazios", function (Given, When, Then) {
		...
		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouNoEstadoEsperado("idInputNome", "Error");

		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouNoEstadoEsperado("idInputPreco", "Error");

		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouNoEstadoEsperado("idSelectGenero", "Error");
	});
	...
	opaTest("Os inputs devem ficar com texto de campo obrigatório caso estejam vazios", function (Given, When, Then) {
		...
		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouComTextoDeCampoObrigatorio("idInputNome", "O campo nome é obrigatório");

		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouComTextoDeCampoObrigatorio("idInputPreco", "O campo preço é obrigatório");

		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouComTextoDeCampoObrigatorio("idSelectGenero", "O campo gênero é obrigatório");
	});
	...
	opaTest("O input nome deve ficar em estado padrão caso seja preenchido", function (Given, When, Then) {
		...
		When
			.paginaAdicionarOuEditarJogo
			.adicionarValorAoInputNome("FarCry4");
		...
		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouNoEstadoEsperado("idInputNome", "None");
	});
	...
	opaTest("O input preço deve ficar em estado padrão caso seja preenchido", function (Given, When, Then) {
		...
		When
			.paginaAdicionarOuEditarJogo
			.adicionarValorAoInputPreco("100");
		...
		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouNoEstadoEsperado("idInputPreco", "None");
	});
	...
	opaTest("O select gênero deve ficar em estado padrão caso seja preenchido", function (Given, When, Then) {
		...
		Then
			.paginaAdicionarOuEditarJogo
			.oInputComIdCorrespondenteFicouNoEstadoEsperado("idSelectGenero", "None");
	});
	...
	opaTest("Deve ser possível ver a caixa de mensagem de erro", function (Given, When, Then) {
		...
		When
			.paginaAdicionarOuEditarJogo
			.adicionarValorAoInputNome("Minecraft");

		When
			.paginaAdicionarOuEditarJogo
			.adicionarValorAoInputPreco("20000");
	...
	opaTest("Deve ser possível clicar em OK na caixa de mensagem de sucesso", function (Given, When, Then) {
		...
		When
			.paginaAdicionarOuEditarJogo
			.adicionarValorAoInputNome("FarCry 5");

		When
			.paginaAdicionarOuEditarJogo
			.adicionarValorAoInputPreco("120");

		When
			.paginaAdicionarOuEditarJogo
			.selecionarGeneroNoSelect("FPA");
		...
		When
			.paginaAdicionarOuEditarJogo
			.aoClicarNoBotaoDeOkNaCaixaDeMensagemDeSucesso();
